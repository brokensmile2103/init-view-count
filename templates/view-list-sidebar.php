...
<div class="init-plugin-suite-view-count-item">
	...
	<div class="init-plugin-suite-view-count-meta">
		...
		<span class="init-plugin-suite-view-count-date">
			...
			<?php
			$human_time = human_time_diff( (int) get_post_time( 'U', true, $item ), time() );
			echo esc_html( $human_time ? $human_time : get_the_date( '', $item ) );
			?>
		</span>
		...
		<span class="init-plugin-suite-view-count-count init-plugin-suite-view-count-margin-small-left">
			<span class="init-plugin-suite-view-count-icon">
				<svg width="20" height="20" viewBox="0 0 20 20">
					...
					<path fill="none" stroke="#000" d="m19.5,10c-2.4,3.66-5.26,7-9.5,7h0c-4.24,0-7.1-3.34-9.49-7C2.89,6.34,5.75,3,9.99,3h0c4.25,0,7.11,3.34,9.5,7Z"></path>
				</svg>
			</span>
